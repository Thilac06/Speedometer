...
class Speedometer(tk.Canvas):
    ...
    def draw_tick(self, angle):
        # Convert angle to radians and calculate tick position
        radian_angle = math.radians(angle)
        x_outer = 100 + 80 * math.sin(radian_angle)
        y_outer = 100 - 80 * math.cos(radian_angle)
        x_inner = 100 + 70 * math.sin(radian_angle)
        y_inner = 100 - 70 * math.cos(radian_angle)

        # Draw tick line
        self.create_line(x_outer, y_outer, x_inner, y_inner, width=2, fill='#333333')
